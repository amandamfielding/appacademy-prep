...
def transmogrify(word,options={})
  ...
  transmogrified_word = word
  transmogrified_word = transmogrified_word.upcase if options[:upcase]
  transmogrified_word = transmogrified_word.reverse if options[:reverse]
  transmogrified_word * options[:times]
end